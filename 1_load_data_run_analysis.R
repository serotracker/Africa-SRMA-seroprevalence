...
#paths
script_path = "scripts/"
data_path <- "data/analysis/revision/"
...
max_cases<-0.02
p1<-time_plot_function("Eastern Africa")
p4<-time_plot_function("Western Africa")
max_cases<-0.05
p3<-time_plot_function("Southern Africa")
p2<-time_plot_function("Middle Africa")
pdf("figures/Figure 3_.pdf",height=8,width=10.5)
plot_grid(p1, p3, p4, p2, ncol=2, nrow=2)
ggsave("figures/Figure 3_.png",height=8,width=10.5)
